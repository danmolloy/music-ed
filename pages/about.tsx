...
export default function About() {
  return (
    <Layout>
      <div className='m-4 md:w-2/3 lg:w-1/2 text-slate-800'>
        <h1 className='mb-2 text-blue-600 text-4xl'>About</h1>
      ...
      <Link href="/exercises">
        <PrimaryButton className="bg-blue-600 text-white hover:bg-blue-400" text="Start"/>
      </Link>
    </Layout>
  )
}